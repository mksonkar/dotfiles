...
locker="i3lock --nofork --ignore-empty-password --show-failed-attempts --clock --radius 135 --pass-media-key -i /home/mkso/Pictures/wallpapers/minimalistic/gruvbox_minimal_space.png -C"
